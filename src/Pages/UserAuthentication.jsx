    ...
    <>
      ...
      >
        <article
          ...
          style={{ height: "7vh" }}
        >
          <Button title="Register" handler={setPage} bsStyles={"btn btn-light"} valueString={"register"}  />
          <Button title={"Sign In"} handler={setPage} bsStyles={"btn btn-light"} valueString={"login"}  />
        </article>
